Made by: Roel Hoogendoorn / Roelieboy204 / Roel204
Please check out Zero-G Guns on Steam!

Use this package to easily add sound to your game with easy to change AudioMixerGroups.

How to use:
- Place the SoundManager prefab in all your scenes.
- Add the audio files you want to use to the SoundManager prefab.
